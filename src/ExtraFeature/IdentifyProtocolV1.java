...
import org.apache.commons.codec.binary.Base64;
 ...
 public class IdentifyProtocolV1 {
 	...
 	private String getUTCTimeSeconds() {  
 	    ...
 	    String time = cal.getTimeInMillis()/1000 + "";
 	...
 	public static String getSong() throws Exception {
 		File file = new File("C:\\Users\\rithel\\Desktop\\CS2108\\Assignment2\\data\\input\\recorded.wav");
        ...
        // Replace "xxxxxxxx" below with your project's access_key and access_secret.
 		//http://ap-southeast-1.api.acrcloud.com/v1/identify
 		String result = a.recognize("ap-southeast-1.api.acrcloud.com", "c41eeb30c7c7e58264608f113f540bdc", "B72Icnuz0GuroizQb12Mi8NhST5pnxNT4DhWO3dA", postDatas, "audio", 80000);
// 		System.out.println("TITLE: "+getSongName(result));
// 		System.out.println(result);
 		return getSongName(result);
 	}
 	public static String getSongName(String result){
 		String songname = "";
 		...
 		for (String s :titleCount.keySet()){
 			if (titleCount.get(s)>max){
 				max = titleCount.get(s);
 				songname = s;
 			}
 		}
 		if (max == 1) {
